  ...
  "cells": [
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "TwFwJ_4HW1Uu",
        "outputId": "73f56f87-55d9-464d-9438-98995de67240"
      },
      "execution_count": 31,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "7pI1sCyPinjk",
        "outputId": "c8fd64bc-f734-479c-f90a-535d30dd962d"
      },
      "execution_count": 32,
      "outputs": [
        {
          ...
          "data": {
            ...
            "text/html": [
              "\n",
              "  <div id=\"df-d1648147-e273-4bb4-acda-182572c17ca9\">\n",
              ...
              "</div>\n",
              "      <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-d1648147-e273-4bb4-acda-182572c17ca9')\"\n",
              ...
              "      <script>\n",
              "        const buttonEl =\n",
              "          document.querySelector('#df-d1648147-e273-4bb4-acda-182572c17ca9 button.colab-df-convert');\n",
              "        buttonEl.style.display =\n",
              "          google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "        async function convertToInteractive(key) {\n",
              "          const element = document.querySelector('#df-d1648147-e273-4bb4-acda-182572c17ca9');\n",
              "          const dataTable =\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "1ZPMUJF0igZn",
        "outputId": "8c74d468-7a58-47c4-e1b3-e69f788808d5"
      },
      "execution_count": 33,
      "outputs": [
        {
          ...
          "data": {
            ...
            "text/html": [
              "\n",
              "  <div id=\"df-afbfc94f-f98a-4b2f-899d-8dea5c2ccf27\">\n",
              "    <div class=\"colab-df-container\">\n",
              "      <div>\n",
              "<style scoped>\n",
              "    .dataframe tbody tr th:only-of-type {\n",
              ...
              "</table>\n",
              "</div>\n",
              "      <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-afbfc94f-f98a-4b2f-899d-8dea5c2ccf27')\"\n",
              "              title=\"Convert this dataframe to an interactive table.\"\n",
              "              style=\"display:none;\">\n",
              "        \n",
              "  <svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\"viewBox=\"0 0 24 24\"\n",
              ...
              "      <script>\n",
              "        const buttonEl =\n",
              "          document.querySelector('#df-afbfc94f-f98a-4b2f-899d-8dea5c2ccf27 button.colab-df-convert');\n",
              "        buttonEl.style.display =\n",
              "          google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "        async function convertToInteractive(key) {\n",
              "          const element = document.querySelector('#df-afbfc94f-f98a-4b2f-899d-8dea5c2ccf27');\n",
              "          const dataTable =\n",
              "            await google.colab.kernel.invokeFunction('convertToInteractive',\n",
              "                                                     [key], {});\n",
              "          if (!dataTable) return;\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "YGsqLObbojCy",
        "outputId": "eaaf069a-90fe-4c93-cc11-59aee8bb5149"
      },
      "execution_count": 34,
      "outputs": [
        {
          ...
          "data": {
            ...
            "text/html": [
              "\n",
              "  <div id=\"df-7bc5c5b6-5878-414d-a31f-536e5dcc43d0\">\n",
              "    <div class=\"colab-df-container\">\n",
              "      <div>\n",
              "<style scoped>\n",
              "    .dataframe tbody tr th:only-of-type {\n",
              ...
              "</table>\n",
              "</div>\n",
              "      <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-7bc5c5b6-5878-414d-a31f-536e5dcc43d0')\"\n",
              "              title=\"Convert this dataframe to an interactive table.\"\n",
              "              style=\"display:none;\">\n",
              "        \n",
              "  <svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\"viewBox=\"0 0 24 24\"\n",
              ...
              "      <script>\n",
              "        const buttonEl =\n",
              "          document.querySelector('#df-7bc5c5b6-5878-414d-a31f-536e5dcc43d0 button.colab-df-convert');\n",
              "        buttonEl.style.display =\n",
              "          google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "        async function convertToInteractive(key) {\n",
              "          const element = document.querySelector('#df-7bc5c5b6-5878-414d-a31f-536e5dcc43d0');\n",
              "          const dataTable =\n",
              "            await google.colab.kernel.invokeFunction('convertToInteractive',\n",
              "                                                     [key], {});\n",
              "          if (!dataTable) return;\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "h8mglwM1p622",
        "outputId": "d4bc0351-4b6f-4f5d-b595-d9a946d566bd"
      },
      "execution_count": 35,
      "outputs": [
        {
          ...
          "data": {
            ...
            "text/html": [
              "\n",
              "  <div id=\"df-cb1d7f58-b95b-4a1b-bd8f-f4e2ca541862\">\n",
              "    <div class=\"colab-df-container\">\n",
              "      <div>\n",
              "<style scoped>\n",
              "    .dataframe tbody tr th:only-of-type {\n",
              ...
              "</table>\n",
              "</div>\n",
              "      <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-cb1d7f58-b95b-4a1b-bd8f-f4e2ca541862')\"\n",
              "              title=\"Convert this dataframe to an interactive table.\"\n",
              "              style=\"display:none;\">\n",
              "        \n",
              "  <svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\"viewBox=\"0 0 24 24\"\n",
              ...
              "      <script>\n",
              "        const buttonEl =\n",
              "          document.querySelector('#df-cb1d7f58-b95b-4a1b-bd8f-f4e2ca541862 button.colab-df-convert');\n",
              "        buttonEl.style.display =\n",
              "          google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "        async function convertToInteractive(key) {\n",
              "          const element = document.querySelector('#df-cb1d7f58-b95b-4a1b-bd8f-f4e2ca541862');\n",
              "          const dataTable =\n",
              "            await google.colab.kernel.invokeFunction('convertToInteractive',\n",
              "                                                     [key], {});\n",
              "          if (!dataTable) return;\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "R_wuqbI0qo69",
        "outputId": "7817fb65-ebaa-4cfb-8a46-fd159f462a34"
      },
      "execution_count": 36,
      "outputs": [
        {
